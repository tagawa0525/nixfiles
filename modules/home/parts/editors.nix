...
in
{
  ...
  home.activation.removeStaleVscodeExtensionLinks = lib.hm.dag.entryBefore [ "linkGeneration" ] ''
  ...
  home.activation.fixCopilotChatGlobalStoragePerms = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
